...
// ========================================================
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwVRAlTOTxjqKQ4C_L-Btsb1xxuICGZxZGT5JMzriCsf7vFup_k0vofcdpQGlQ1zEo-3A/exec"
    ...
    try {
        ...
        if (text && text.trim().startsWith("{")) {
            ...
            const mapped = {
                ...
                customerPhone: customer.customerPhone || getInvVal(customer, "Phone number", "Phone Number", "Phone", "phone", "customerPhone") || phone,
                ...
                customerAddress: customer.customerAddress || getInvVal(customer, "Billing address", "Billing Address", "customerAddress", "Address", "Permanent address", "Permanent_address", "address")
            };
