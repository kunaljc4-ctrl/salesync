...
// ========================================================
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyYK8GwyAvK7-0EhDRqc9dAvl5qZC6TJcRhXz44tupqNJRqx0Y_M7Dk2stATx_zbjKZig/exec"
    ...
    try {
        ...
        if (text && text.startsWith("{")) {
            ...
            const mapped = {
                ...
                customerPhone: customer["Phone number"] || customer.phone || phone,
                altPhone: customer.altPhone || customer["Alternate Phone"] || "",
                customerEmail: customer.customerEmail || customer.email || "",
                customerAddress: customer.customerAddress || customer.address || customer["Permanent address"] || ""
            };
        ...
        console.warn("Server lookup failed", err);
        return false;
    }
}
