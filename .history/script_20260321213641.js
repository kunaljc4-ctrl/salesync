...
// ========================================================
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxUURsLYsBVY9N_IgnucmnDz6Q_VAUhWHKnIB_Mi8JsmgyWekqXc33yB4Vu152Am1vTDw/exec"
...
function populateAnalyticsNav() {
    ...
    const getPaymentMode = (r) => {
        let val = getInvVal(r, "paymentMode", "PaymentMode", "Payment Mode", "Payment", "Payment method", "Mode", "Pay Mode", "Type", "Sales Mode");
    ...
    if (exactDateInput) {
        if (!exactDateInput.value) {
            exactDateInput.value = new Date().toISOString().split('T')[0];
        }
...
function processAndRenderAnalytics() {
    ...
    const filteredResults = globalAnalyticsData.filter(row => {
        if (filteredSegment) {
            const seg = getInvVal(row, "paymentMode", "PaymentMode", "Payment Mode", "Payment", "Payment method", "Mode", "Pay Mode", "Type", "Sales Mode");
    ...
    filteredResults.forEach(row => {
        ...
        let segmentRaw = getInvVal(row, "paymentMode", "PaymentMode", "Payment Mode", "Payment", "Payment method", "Mode", "Pay Mode", "Type", "Sales Mode");
